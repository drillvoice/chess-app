...
export const trainingSessionsTable = pgTable("training_sessions", {
  ...
  studyType: text("study_type"), // 'video', 'book', 'analysis', 'opening', 'endgame', 'chessable', 'online-course', 'coaching'
...
export const studySessionSchema = insertTrainingSessionSchema.extend({
  ...
  duration: z.number().min(1, "Duration must be at least 1 minute"),
  studyType: z.enum(['video', 'book', 'analysis', 'opening', 'endgame', 'chessable', 'online-course', 'coaching'], {
