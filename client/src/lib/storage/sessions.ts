...
export async function getSessions(): Promise<TrainingSession[]> {
  return withStores([SESSIONS], 'readonly', async ({ sessions }) => {
...
export async function setSessions(sessionsList: TrainingSession[]): Promise<void> {
  await withStores([SESSIONS, META], 'readwrite', async ({ sessions, cache_meta }) => {
...
export async function updateSession(
  ...
  return withStores([SESSIONS, META], 'readwrite', async ({ sessions, cache_meta }) => {
...
export async function removeSession(id: number): Promise<void> {
  await withStores([SESSIONS], 'readwrite', async ({ sessions }) => {
...
export async function markAsUnsynced(
  ...
  await withStores([QUEUE], 'readwrite', async ({ sync_queue }) => {
...
export async function getUnsyncedSessions(): Promise<UnsyncedSession[]> {
  return withStores([QUEUE], 'readonly', async ({ sync_queue }) => {
