    ...
    <div className="page-stack">
      <div className="grid gap-4 md:grid-cols-2 md:gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-gray-600">
              This app is still in development. I've been using it for weeks and it works for me,
              but I'm sure it could work better! If you have any feedback or comments,{' '}
              <a
                className="text-blue-800 underline"
